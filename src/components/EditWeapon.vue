<template>
  <ApolloMutation
    :mutation="require('@/graphql/updateOneWeapon.gql')"
    :variables="{
        id: id || weaponID,
        name,
        category,
...
export default {
  ...
  created() {
    this.$apollo.queries.weapon.refetch().then(res => {
      this.name = res.data.weapon.name;
      this.category = res.data.weapon.category;
      this.type = res.data.weapon.type;
      this.dice = res.data.weapon.dice;
      this.adds = res.data.weapon.adds;
      this.strengthReq = res.data.weapon.strengthReq;
      this.dexReq = res.data.weapon.dexReq;
      this.cost = res.data.weapon.cost;
      this.weight = res.data.weapon.weight;
      this.range = res.data.weapon.range;
      this["length"] = res.data.weapon["length"];
      this.extraInfo = res.data.weapon.extraInfo;
    });
  },
  apollo: {
    weapon: {
      query: require("@/graphql/getWeapon.gql"),
      variables() {
        return {
          id: this.id || this.weaponID
        };
      }
    }
  }
